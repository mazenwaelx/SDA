...
public class Notification {
    ...
    private String notificationId; // Unique identifier for each notification
    ...
    public Notification(String recipient, String message, NotificationType type, String timestamp, Map<String, String> placeholders) {
        this.recipient = recipient;
        this.message = message;
        this.type = type;
        this.timestamp = timestamp;
